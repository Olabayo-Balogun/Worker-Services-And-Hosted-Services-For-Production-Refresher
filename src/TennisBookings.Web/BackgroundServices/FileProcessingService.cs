...
namespace TennisBookings.Web.BackgroundServices
{
    public class FileProcessingService : BackgroundService
    {
        ...
        {
            //This works in such a way that if any new file name appears, it can be read and processed.
            await foreach (var fileName in _fileProcessingChannel.ReadAllAsync())
            {
                //This lives for each instantiation of the processing loop.
                ...
                {
                    //This ensures that a file is deleted
